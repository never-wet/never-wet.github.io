...
The publish script runs `next build`, copies the static export into this project folder, and removes the temporary `out/` directory so the app can be served from GitHub Pages at `/sorting-algorithm-visualizer/`.
