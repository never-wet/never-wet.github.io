...
4. Create an overworld route/town/dungeon layout in `src/data/locations/overworldMaps.ts`.
5. Add a background asset in `src/memory/assetManifest.ts`.
6. Map its music/ambience in `src/data/audio/audioRoutes.ts`.
