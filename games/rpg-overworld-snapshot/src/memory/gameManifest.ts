...
export const gameManifest: GameManifest = {
  id: "hollowmere-overworld-snapshot-veil-of-the-hollow-star",
  title: "Hollowmere Overworld Snapshot: Veil of the Hollow Star",
  subtitle: "A preserved graphical top-down fantasy RPG build",
  version: "0.1.0",
  tagline: "A saved map-first Hollowmere build with live movement, field routes, and the Veil Shard already in hand.",
  pitch:
    "A preserved top-down browser RPG build with tile-based movement, overworld hotspots, field encounters, story scenes, and separate local-first saves.",
  chapters: [
    {
      id: "prologue",
      label: "Prologue",
