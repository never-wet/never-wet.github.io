...
export type OverworldEnvironment = "town" | "interior" | "forest" | "marsh" | "abbey" | "spire";
export type InteractionTrigger = "interact" | "step";
...
export interface EventIndexEntry {
  ...
  chapterId: ChapterId;
  locationId: string;
  kind: "scene" | "encounter" | "pickup" | "flag";
  triggerType: InteractionTrigger | "battleVictory" | "menu";
  sourceId: string;
  rewards?: string[];
}
...
export interface BattleIndexEntry {
  ...
  chapterId: ChapterId;
  locationId: string;
  tier: "tutorial" | "field" | "elite" | "boss";
  enemyIds: string[];
