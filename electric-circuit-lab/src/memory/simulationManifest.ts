  ...
  phases: [
    {
      ...
      supportedBehaviors: [
        ...
        'Branch current summaries for active source paths',
        'Resistor voltage drop estimates',
        'LED and lamp on or off feedback',
        'Switch and push button logic',
        'Capacitor DC steady-state approximation',
        'Inductor DC steady-state approximation',
        'Transistor switching approximation',
        'Grounded node hints',
