...
import { AlertTriangle, Box, Camera, Home, Radar } from "lucide-react";
...
type ObjectScannerProps = {
  onRoomScanSelect: () => void;
};
...
export function ObjectScanner({ onRoomScanSelect }: ObjectScannerProps) {
      ...
      <header className="scanner-topbar">
        ...
        <div className="scanner-title">
          ...
          <div className="scan-kind-toggle" aria-label="Scan target">
            ...
            <button type="button" onClick={onRoomScanSelect}>
              <Radar size={15} />
              Room Scan
            </button>
          </div>
